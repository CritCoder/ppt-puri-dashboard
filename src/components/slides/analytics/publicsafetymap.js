...
const MapView = ({ onCameraSelect }) => {
  ...
  const [mapCenter, setMapCenter] = useState({ lat: 23.1793, lng: 75.8349 });
  ...
  const cameras = [
    {
      id: 1,
      name: "Mahakal Temple Main Gate",
      position: { lat: 23.1829, lng: 75.7684 },
      type: "ptz"
    },
    {
      id: 2,
      name: "Mahakal Temple South Gate",
      position: { lat: 23.1825, lng: 75.7687 },
      type: "dome"
    },
    {
      id: 3,
      name: "Ram Ghat",
      position: { lat: 23.1821, lng: 75.7671 },
      type: "ptz"
    },
    {
      id: 4,
      name: "Ujjain Railway Station",
      position: { lat: 23.1712, lng: 75.7879 },
      type: "ptz"
    },
    {
      id: 5,
      name: "Tower Chowk",
      position: { lat: 23.1836, lng: 75.7847 },
      type: "dome"
    },
    {
      id: 6,
      name: "Freeganj Tower",
      position: { lat: 23.1842, lng: 75.7852 },
      type: "ptz"
    },
    {
      id: 7,
      name: "Gopal Mandir",
      position: { lat: 23.1827, lng: 75.7775 },
      type: "dome"
    },
    {
      id: 8,
      name: "Kanthal Area",
      position: { lat: 23.1789, lng: 75.7843 },
      type: "fixed"
    },
    {
      id: 9,
      name: "Dewas Gate",
      position: { lat: 23.1873, lng: 75.7868 },
      type: "ptz"
    },
    {
      id: 10,
      name: "Hari Phatak Bridge",
      position: { lat: 23.1798, lng: 75.7732 },
      type: "dome"
    },
    {
      id: 11,
      name: "Begum Bagh",
      position: { lat: 23.1756, lng: 75.7812 },
      type: "fixed"
    },
    {
      id: 12,
      name: "Narsing Ghat",
      position: { lat: 23.1814, lng: 75.7677 },
      type: "ptz"
    },
    {
      id: 13,
      name: "Chakratirth Road",
      position: { lat: 23.1803, lng: 75.7692 },
      type: "fixed"
    },
    {
      id: 14,
      name: "Vikram University",
      position: { lat: 23.1776, lng: 75.7854 },
      type: "dome"
    },
    {
      id: 15,
      name: "Nanakheda Bus Stand",
      position: { lat: 23.1712, lng: 75.7789 },
      type: "ptz"
    }
  ];
    ...
    <div className="relative w-full h-full">
      <div className="absolute top-6 left-1/2 transform -translate-x-1/2 z-10 w-96">
        ...
        >
          <input
            type="text"
            placeholder="Search location (e.g., Mahakal Temple)"
        ...
        {!showCameras && (
          ...
          >
            <div className="px-6 py-4 bg-black/80 backdrop-blur-md rounded-lg border border-white/10">
              <h3 className="text-white font-medium mb-2">Ujjain Surveillance Network</h3>
...
const PublicSafetyMap = ({ selectedThreat, onCameraSelect }) => {
  const { isLoaded } = useLoadScript({
    googleMapsApiKey: "AIzaSyBWhqRzAuNA-EnG0vodnS377w_nCVYQz04",
    libraries: ['places']
  });
  ...
  useEffect(() => {
    if (selectedThreat) {
      setMapCenter(selectedThreat.coordinates);
      setZoom(16);
      setShowCameras(true);
    }
  }, [selectedThreat]);
...
export default PublicSafetyMap; 